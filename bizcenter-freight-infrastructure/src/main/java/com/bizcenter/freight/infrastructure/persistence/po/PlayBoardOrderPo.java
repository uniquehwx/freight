...
@TableName(value = "lc_play_board_order", resultMap = "playBoardOrderMap")
public class PlayBoardOrderPo extends BasePo<PlayBoardOrderPo> implements Serializable{
    private static final long serialVersionUID = 1L;

    public PlayBoardOrderPo(){

    }
    public PlayBoardOrderPo(Long id){
        this.id = id;
    }
