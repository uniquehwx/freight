...
@TableName(value = "lc_transport_order", resultMap = "transportOrderMap")
public class TransportOrderPo extends BasePo<TransportOrderPo> implements Serializable{
    private static final long serialVersionUID = 1L;

    public TransportOrderPo(){

    }
    public TransportOrderPo(Long id){
        this.id = id;
    }
