 ...
 */
@Api(value = "securityOrder", description = "安检订单表接口", tags = {"securityOrder"})
public interface SecurityOrderApi {
     ...
     * @return 返回新创建的资源对象
     */
    @ApiOperation(value = "创建一个资源对象（返回新创建的资源对象）", tags = {"securityOrder"}, nickname = "addSecurityOrder")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "000000:成功，否则失败")})
    ResultDTO<SecurityOrderResDto> addSecurityOrder(SecurityOrderReqDto reqDto);
     ...
     * @return 返回一个空文档
     */
    @ApiOperation(value = "删除单个或一系列资源对象", tags = {"securityOrder",}, nickname = "deleteSecurityOrder")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<Void> deleteSecurityOrder(String ids);
    ...
    @ApiOperation(value = "查询一系列资源对象，也就是列表(qp-参数支持的操作符号有: eq(=),ne(!=),gt(>),lt(<),ge(>=),le(<=),in,like,notLike,likeleft(左边LIKE '%xxx'),likeright(右边LIKE 'xx%'))", tags = {
        "securityOrder",}, nickname = "getSecurityOrderList")
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<Pager<SecurityOrderResDto>> getSecurityOrderList(Map<String, Object> params);
     ...
     * @return 返回单独的资源对象
     */
    @ApiOperation(value = "查询一个资源对象", tags = {"securityOrder"}, nickname = "getOneSecurityOrder")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<SecurityOrderResDto> getOneSecurityOrder(Long id);
     ...
     * @return 返回单独的资源对象
     */
    @ApiOperation(value = "查询一个资源对象(若不唯一则随机返回符合条件的一个)", tags = {"securityOrder"}, nickname = "getOneSecurityOrderByMap")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @ApiImplicitParams({
    ...
    ResultDTO<SecurityOrderResDto> getOneSecurityOrder(Map<String, Object> params);
     ...
     * @return 返回完整的资源对象
     */
    @ApiOperation(value = "更新一个资源对象(更新参数的全部属性)", tags = {"securityOrder"}, nickname = "updateSecurityOrderByMap")
    @ApiImplicitParams({
        @ApiImplicitParam(name = "modifyUserName", value = "更新人姓名", paramType = "query"),
        @ApiImplicitParam(name = "modifyUserId", value = "更新人ID", paramType = "query"),
        @ApiImplicitParam(name = "createUserName", value = "创建人命名", paramType = "query"),
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<SecurityOrderResDto> updateSecurityOrder(Long id, Map<String, Object> params);
    /**
     * 更新一个资源对象(部分更新)
     *
     * @return 返回完整的资源对象
     */
    @ApiOperation(value = "更新一个资源对象(部分更新,更新对象里有值的属性,空值不更新)", tags = {"securityOrder"}, nickname = "patchUpdateSecurityOrder")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<SecurityOrderResDto> patchUpdateSecurityOrder(Long id, SecurityOrderReqDto reqDto);
     ...
     * @return 返回完整的资源对象
     */
    @ApiOperation(value = "更新一个资源对象（更新对象里全部属性，即整个对象替换）", tags = {"securityOrder"}, nickname = "putUpdateSecurityOrder")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<SecurityOrderResDto> putUpdateSecurityOrder(Long id, SecurityOrderReqDto reqDto);
