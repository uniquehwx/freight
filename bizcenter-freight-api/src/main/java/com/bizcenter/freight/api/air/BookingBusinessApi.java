 ...
 */
@Api(value = "bookingBusiness", description = "订舱服务表 接口", tags = {"bookingBusiness"})
public interface BookingBusinessApi {
     ...
     * @return 返回新创建的资源对象
     */
    @ApiOperation(value = "创建一个资源对象（返回新创建的资源对象）", tags = {"bookingBusiness"}, nickname = "addBookingBusiness")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "000000:成功，否则失败")})
    ResultDTO<BookingBusinessResDto> addBookingBusiness(BookingBusinessReqDto reqDto);
     ...
     * @return 返回一个空文档
     */
    @ApiOperation(value = "删除单个或一系列资源对象", tags = {"bookingBusiness",}, nickname = "deleteBookingBusiness")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<Void> deleteBookingBusiness(String ids);
    ...
    @ApiOperation(value = "查询一系列资源对象，也就是列表(qp-参数支持的操作符号有: eq(=),ne(!=),gt(>),lt(<),ge(>=),le(<=),in,like,notLike,likeleft(左边LIKE '%xxx'),likeright(右边LIKE 'xx%'))", tags = {
        "bookingBusiness",}, nickname = "getBookingBusinessList")
    @ApiImplicitParams({@ApiImplicitParam(name = "currentPage", value = "当前页数", paramType = "query", dataType = "long"),
        ...
        @ApiImplicitParam(name = "qp-orderNo-eq", value = "订舱服务单号", paramType = "query"),
        ...
        @ApiImplicitParam(name = "qp-billLadingNo-eq", value = "提单号", paramType = "query"),
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<Pager<BookingBusinessResDto>> getBookingBusinessList(Map<String, Object> params);
     ...
     * @return 返回单独的资源对象
     */
    @ApiOperation(value = "查询一个资源对象", tags = {"bookingBusiness"}, nickname = "getOneBookingBusiness")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<BookingBusinessResDto> getOneBookingBusiness(Long id);
     ...
     * @return 返回单独的资源对象
     */
    @ApiOperation(value = "查询一个资源对象(若不唯一则随机返回符合条件的一个)", tags = {"bookingBusiness"}, nickname = "getOneBookingBusinessByMap")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @ApiImplicitParams({
        @ApiImplicitParam(name = "status", value = "10 创建服务  20 完成服务  30服务取消", paramType = "query"),
        @ApiImplicitParam(name = "orderNo", value = "订舱服务单号", paramType = "query"),
        ...
        @ApiImplicitParam(name = "billLadingNo", value = "提单号", paramType = "query"),
    ...
    ResultDTO<BookingBusinessResDto> getOneBookingBusiness(Map<String, Object> params);
     ...
     * @return 返回完整的资源对象
     */
    @ApiOperation(value = "更新一个资源对象(更新参数的全部属性)", tags = {"bookingBusiness"}, nickname = "updateBookingBusinessByMap")
    @ApiImplicitParams({
        @ApiImplicitParam(name = "status", value = "10 创建服务  20 完成服务  30服务取消", paramType = "query"),
        @ApiImplicitParam(name = "orderNo", value = "订舱服务单号", paramType = "query"),
        @ApiImplicitParam(name = "customerNo", value = "客户订单号", paramType = "query"),
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<BookingBusinessResDto> updateBookingBusiness(Long id, Map<String, Object> params);
    /**
     * 更新一个资源对象(部分更新)
     *
     * @return 返回完整的资源对象
     */
    @ApiOperation(value = "更新一个资源对象(部分更新,更新对象里有值的属性,空值不更新)", tags = {"bookingBusiness"}, nickname = "patchUpdateBookingBusiness")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<BookingBusinessResDto> patchUpdateBookingBusiness(Long id, BookingBusinessReqDto reqDto);
     ...
     * @return 返回完整的资源对象
     */
    @ApiOperation(value = "更新一个资源对象（更新对象里全部属性，即整个对象替换）", tags = {"bookingBusiness"}, nickname = "putUpdateBookingBusiness")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    ResultDTO<BookingBusinessResDto> putUpdateBookingBusiness(Long id, BookingBusinessReqDto reqDto);
