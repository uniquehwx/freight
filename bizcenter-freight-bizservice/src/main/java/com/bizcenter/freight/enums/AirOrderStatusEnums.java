...
public enum AirOrderStatusEnums {
    ...
    AirOrderStatusEnums(String type, String code, String typeName) {
        this.type = type;
        this.code = code;
    ...
    public static AirOrderStatusEnums getEnumByCode(String type) {
        for (AirOrderStatusEnums enums : AirOrderStatusEnums.values()) {
