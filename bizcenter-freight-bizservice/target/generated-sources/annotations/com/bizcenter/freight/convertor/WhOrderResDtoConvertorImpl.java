...
public class WhOrderResDtoConvertorImpl extends WhOrderResDtoConvertor {
    ...
    @Override
    public String dto2Po(WhOrderResDto arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public WhOrderResDto po2Dto(String arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public List<String> dtoList2PoList(List<WhOrderResDto> arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public List<WhOrderResDto> poList2DtoList(List<String> arg0) {
        if ( arg0 == null ) {
            return null;
        }
